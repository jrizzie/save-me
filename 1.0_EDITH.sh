...
clear
	...
	if [[ $last = y ]] ; then
		...
		sleep 1
		echo ...
		echo 'Moloch should be available at 127.0.0.1:8005'
		echo 'user:  jrizzie'
		echo 'pass:  golicksomeB@115'
		echo 'The Hive should be available at 127.0.0.1:9000'
		echo 'user:  admin'
		echo 'pass:  golicksomeB@115'
		fi
fi
